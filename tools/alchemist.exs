defmodule Alchemist do
  @moduledoc """
  Utility service for completion etc.

  ## Lovingly ripped off from https://github.com/tonini/alchemist.el
  ...
  defmodule Server do
    ...
    def purge_paths(paths) do
      for p <- paths, do: Code.delete_path(p)
    end

    def purge_apps(apps) do
